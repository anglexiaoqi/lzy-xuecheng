...
import com.xuecheng.web.config.AppConfig;
...
public class FastConnectionPool {
	...
	@Autowired
	private AppConfig FASTDFS_CONFIG;
	...
	private void initClientGlobal() throws Exception {
		log.info("{}" , FASTDFS_CONFIG.getP());
		ClientGlobal.initByProperties(FASTDFS_CONFIG.getP());
	}
