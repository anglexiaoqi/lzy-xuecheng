...
public class ExcelUtil<T> {
    ...
    {  
    	return exportExcelTitle(list,sheetName,sheetSize,output,false); 
    }
    
    @SuppressWarnings("deprecation")
	public boolean exportExcelTitle(List<T> list, String sheetName, int sheetSize,OutputStream output,boolean showTitle)
    {  
